...
<nav style="background-color: #16A2CB; position: fixed; top: 0; width: 100%; z-index: 1000; padding: 10px; overflow-x: auto;">
  <ul style="list-style-type: none; padding: 0; margin: 0; display: flex; justify-content: flex-start; flex-wrap: nowrap; overflow-x: auto;">
    <li><a style="text-decoration: none; color: white; margin-right: 15px;" href="/">Home</a></li>
    <li><a style="text-decoration: none; color: white; margin-right: 15px;" href="#educacion">Educacion</a></li>
    <li><a style="text-decoration: none; color: white; margin-right: 15px;" href="#experiencia-de-trabajo">Experiencia de Trabajo</a></li>
    <li><a style="text-decoration: none; color: white; margin-right: 15px;" href="#herramientas-informaticas">Herramientas Informaticas</a></li>
    <li><a style="text-decoration: none; color: white; margin-right: 15px;" href="#social-media">Social Media</a></li>
  </ul>
</nav>
