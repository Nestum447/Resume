...
- Desarrollo de modulos Python, VS Code, NumPy, Pandas, Dataframes CSV, JSON, basic Machine Learning scikit-learn, Matplotlib, y Seaborn

- Desarrollo modulos de automatizacion y mejora de tareas en Visual Basic, Bases de Datos
''')
...
''')
txt4('Streamlit Pillow (PIL) – para mostrar imágenes HTML + CSS – para dar formato al menú y estilos JavaScript –', ' Aplicación desarrollada en Streamlit que muestra un Curriculum Vitae (CV) interactivo con navegación por secciones, integración de estilos CSS personalizados y menús fijos de navegación. ', 'https://resume-wcguq3du25zzwaxjdnwnpb.streamlit.app/  ')
